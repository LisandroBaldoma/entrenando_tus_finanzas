@extends('layout.base_sin_nav-footer')
    ...
    <body>
        ...
        <header>
          ...
          <div id="intro" class="p-5 text-center bg-image shadow-1-strong"
            style="background-image: url('/img/comingsonn_fondo.jpg');">
            ...
            <section>
              <div class="row">
                ...
                <div class="col-md-6 gx-5 mb-4">
                  <form
                    {{-- action="{{route ('contdown.formulario') }}" --}}
                  >
                    <!-- Name input -->
                    ...
                    <!-- Submit button -->
                    <button id='suscribir' type="btn" class="btn btn-primary btn-block mb-4" data-mdb-ripple-init>
                      Subscribe
                    </button>
                  </form>
                </div>
        ...
        <!--Footer-->
          ...
          <script>
            $('#suscribir').click(function (e) {
                e.preventDefault();
                console.log('click')
                alert('click')
                // $.ajax(
                //     {
                //     url : "{{ route('contdown.formulario') }}" ,
                //     type: "GET",
                //     data : {idP: ‘10’}
                //     })
                //     .done(function(data) {
