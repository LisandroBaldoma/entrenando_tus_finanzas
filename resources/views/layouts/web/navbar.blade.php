        ...
        <div class="menu-bg-wrap">
            <div class="site-navigation">
                <div class="row g-0 align-items-center">
                    <div class="col-2">
                        <a href="/home" class="logo m-0 float-start"><img src="{{asset('img/logo.jpg')}}" class="rounded-circle" style=" width:60px " alt="..."><span class="text-primary"></span></a>
                        {{-- <img src="{{asset('img/logo.jpg')}}" alt="" style="height:px; width:40px "> --}}
                    </div>
